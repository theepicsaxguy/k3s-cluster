...
|------------|------|---------|
| https://github.com/cilium/cilium-cli | cilium-cli | 0.16.23 |
...
| cilium_vars.kubernetes.loadbalancer.ip_pool.blocks.start | string | `"10.25.150.20"` | `CiliumLoadBalancerIPPool` blocks start address |
| cilium_vars.kubernetes.loadbalancer.ip_pool.blocks.stop | string | `"10.25.150.100"` | `CiliumLoadBalancerIPPool` blocks stop address |
...
| cilium_vars.release.cli.version | string | `"v0.16.23"` |  |
