...
![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![Version: 0.33.5](https://img.shields.io/badge/Version-0.33.5-informational?style=flat-square)

The role performs various tasks related to `victoria-metrics-k8s-stack` [chart](https://github.com/VictoriaMetrics/helm-charts/tree/victoria-metrics-k8s-stack-0.33.5/charts/victoria-metrics-k8s-stack) deployment, reset and validation. Review the [documentation](https://theepicsaxguy.com/k3s-cluster/wiki/guide/configuration/roles/victoriametrics), for additional details.
...
| victoriametrics_vars.kubernetes.alertmanager.ingress.subdomain | string | `"alertmanager"` | See [documentation](https://theepicsaxguy.com/k3s-cluster/tutorials/handbook/externaldns/#front-ends), for details |
...
| victoriametrics_vars.kubernetes.grafana.ingress.subdomain | string | `"grafana"` | See [documentation](https://theepicsaxguy.com/k3s-cluster/tutorials/handbook/externaldns/#front-ends), for details |
...
| victoriametrics_vars.kubernetes.helm.chart.version | string | `"v0.33.5"` |  |
...
| victoriametrics_vars.kubernetes.vmagent.ingress.subdomain | string | `"agent"` | See [documentation](https://theepicsaxguy.com/k3s-cluster/tutorials/handbook/externaldns/#front-ends), for details |
...
| victoriametrics_vars.kubernetes.vmalert.ingress.subdomain | string | `"alert"` | See [documentation](https://theepicsaxguy.com/k3s-cluster/tutorials/handbook/externaldns/#front-ends), for details |
...
| victoriametrics_vars.kubernetes.vmcluster.vminsert.ingress.subdomain | string | `"insert"` | See [documentation](https://theepicsaxguy.com/k3s-cluster/tutorials/handbook/externaldns/#front-ends), for details |
...
| victoriametrics_vars.kubernetes.vmcluster.vmselect.ingress.subdomain | string | `"metrics"` | See [documentation](https://theepicsaxguy.com/k3s-cluster/tutorials/handbook/externaldns/#front-ends), for details |
...
| victoriametrics_vars.kubernetes.vmcluster.vmstorage.ingress.subdomain | string | `"storage"` | See [documentation](https://theepicsaxguy.com/k3s-cluster/tutorials/handbook/externaldns/#front-ends), for details |
...
| victoriametrics_vars.kubernetes.vmsingle.ingress.subdomain | string | `"metrics"` | See [documentation](https://theepicsaxguy.com/k3s-cluster/tutorials/handbook/externaldns/#front-ends), for details |
